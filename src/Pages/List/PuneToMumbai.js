          ...
          <div className="container">
            <div className="row" style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div className="col-md-8" style={{ textAlign: '' }}>
                <h1>Introduction</h1>
                <p>Book your Pune to Mumbai round trip cab package at Just Rs. 2500 Including Toll. Nath krupa provides A/c, Non A/c, Economical, Sedan and Tempo Traveller</p>
                <p>Nath Krupa travels provide the best car service, especially for traveling from Pune to Mumbai by Cab / Taxi and all you need to do is choose us for your travel. Book your tickets now at nathkrupatravels.com.</p>
            ...
            <div className="row" style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'column', alignItems: 'center' }}>
              <div className="col-md-8" style={{ textAlign: 'left' }}>
                ...
                <h1>Duration</h1>
                <p>The distance between Pune and Mumbai is approximately 150 km, and you can reach Mumbai from Pune within 3 to 4 hours by our well-maintained cabs. Enjoy a comfortable and hassle-free journey with Nath Krupa Travels.</p>
              </div>
              <Card className="col-md-4" style={{ maxWidth: '100%', marginBottom: '20px' }}>
            ...
            <p>At Nath Krupa Travels, customer satisfaction is our top priority. We are committed to providing a delightful travel experience to all our customers. With our reliable cab service, you can enjoy a hassle-free journey from Pune to Mumbai.</p>
            ...
            <h1>Book us now</h1>
            <p>Book your Pune to Mumbai cab package today and experience the convenience and comfort of traveling with Nath Krupa Travels. Visit our website nathkrupatravels.com to make an online booking or contact us at +91 8485800099 for inquiries and assistance.</p>
