          ...
          <div className="container">
            <div className="row" style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div className="col-md-8" style={{ textAlign: '' }}>
                <h1>Introduction</h1>
                <p>Book your Pune to Mahabaleshwar round trip cab package at Just Rs. 4500 Including Toll. Nath krupa provides A/c, Non A/c, Economical, Sedan and Tempo Traveller</p>
                <p>Nath Krupa travels provide the best car service, especially for traveling from Pune to Mahabaleshwar by Cab / Taxi and all you need to do is choose us for your travel. Book your tickets now at nathkrupatravels.com.</p>
            ...
            <div className="row" style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'column', alignItems: 'center' }}>
              <div className="col-md-8" style={{ textAlign: 'left' }}>
                ...
                <p>Enjoy the serene ambiance and lush greenery of Mahabaleshwar while our cab service takes you to these enchanting destinations. Make the most of your trip and create unforgettable memories with Nath Krupa Travels.</p>
                <h1>Duration</h1>
            ...
            <p>At Nath Krupa Travels, customer satisfaction is our top priority. We are committed to providing a delightful travel experience to all our customers. With our reliable cab service, you can enjoy a hassle-free journey from Pune to Mahabaleshwar.</p>
            ...
            <h1>Book us now</h1>
            <p>Book your Pune to Mahabaleshwar cab package today and embark on a memorable journey with Nath Krupa Travels. Visit our website nathkrupatravels.com to make an online booking or contact us at +91 8485800099 for inquiries and assistance. Experience the convenience and comfort of traveling with us.</p>
